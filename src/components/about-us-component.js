      ...
      <div>
        ...
        <div className='static-page-container'>
          ...
          <div className='red-divider'></div>
        	<div className='about-us-content'> Being a huge movie fan and having a good large collection of movies I often found myself looking at my movie collection and wondering the right movie to watch that night. It often used to end up in multiple IMDB tabs opened in browser with 15 precious minutes gone. I was also often given the honoured task by my friends of choosing movies from different genre to watch over the weekend. I loved the task. The problem was the extra time and effort that it used to take which could have been spent in actually watching the movie. </div>
          ...
          <div className='about-us-content'> Recently when I was thinking of a small hobby project to work on, I decided to recreate it, and this time, for everyone. For all of us who love watching movies from different genres and have a nice good collection. I hope you love it as much as I do. </div> 
        </div>
      </div>
    );
  }
